<%@ Page Title="" Language="C#" MasterPageFile="~/frames/Frame.Master" AutoEventWireup="true" CodeBehind="MostSupportedIndustryArea.aspx.cs" Inherits="Project_Leap_V3.frames.reports.mixed.MostSupportedIndustryArea" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        function drawRegionsMap() {
            ...
            var type = <%=new JavaScriptSerializer().Serialize(this.arrT) %>;

            //We need to combine the different arrays to add it as rows
            var buildArray = [];
            for(var a = 0; a < code.length; a++)
            {
                buildArray[a] = [code[a], type[a], value[a]];
            }
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <h1>Area of Most Supported NPO types in South Africa</h1>
