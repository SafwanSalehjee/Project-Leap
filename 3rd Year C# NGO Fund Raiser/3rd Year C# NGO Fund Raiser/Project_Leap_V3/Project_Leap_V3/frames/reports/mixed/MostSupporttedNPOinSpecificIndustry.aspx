<%@ Page Title="" Language="C#" MasterPageFile="~/frames/Frame.Master" AutoEventWireup="true" CodeBehind="MostSupporttedNPOinSpecificIndustry.aspx.cs" Inherits="Project_Leap_V3.frames.reports.mixed.MostSupporttedNPOinSpecificIndustry" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        function downloadCSV()
        {
            ...
            a.target      = '_blank';
            a.download    = 'MostSupNPOOfTypeYouLike.csv';
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <h1>Support Offered By Businesses and Individuals to NPO types</h1>
