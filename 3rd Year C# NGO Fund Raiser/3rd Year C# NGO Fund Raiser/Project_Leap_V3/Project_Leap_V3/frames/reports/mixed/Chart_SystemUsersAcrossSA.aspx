<%@ Page Title="" Language="C#" MasterPageFile="~/frames/Frame.Master" AutoEventWireup="true" CodeBehind="Chart_SystemUsersAcrossSA.aspx.cs" Inherits="Project_Leap_V3.frames.reports.mixed.Chart_SystemUsersAcrossSA" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        function downloadCSV()
        {
            ...
            a.target      = '_blank';
            a.download    = 'SysUsersAcrossSA.csv';
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <h1>System users across South Africa</h1>
