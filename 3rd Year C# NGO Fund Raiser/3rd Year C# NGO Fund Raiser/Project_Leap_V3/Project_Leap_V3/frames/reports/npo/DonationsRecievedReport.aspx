<%@ Page Title="" Language="C#" MasterPageFile="~/frames/Frame.Master" AutoEventWireup="true" CodeBehind="DonationsRecievedReport.aspx.cs" Inherits="Project_Leap_V3.frames.reports.npo.DonationsRecievedReport" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        function drawChart() {
            ...
            var npoID = <%=new JavaScriptSerializer().Serialize(this.npoID) %>;
            var buildArray = [];
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <h1>Donations received from donors</h1>
