<%@ Page Title="" Language="C#" MasterPageFile="~/frames/Frame.Master" AutoEventWireup="true" CodeBehind="SysteIncome.aspx.cs" Inherits="Project_Leap_V3.frames.reports.system.SysteIncome" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type='text/javascript'>
        ...
        function drawChart() {
            ...
            var cVal = getCookie("thresholdSys")
        ...
        function setThreshold()
        {
            ...
            document.cookie="thresholdSys=" + ThresholdVal;
            location.reload(); 
        }
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <h1>Income made by the system from transaction charges</h1>
