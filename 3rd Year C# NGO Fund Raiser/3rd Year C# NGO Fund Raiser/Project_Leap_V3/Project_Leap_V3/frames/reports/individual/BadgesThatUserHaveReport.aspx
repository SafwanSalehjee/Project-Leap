<%@ Page Title="" Language="C#" MasterPageFile="~/frames/Frame.Master" AutoEventWireup="true" CodeBehind="BadgesThatUserHaveReport.aspx.cs" Inherits="Project_Leap_V3.frames.reports.individual.BadgesThatUserHaveReport" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        function drawChart() {
            ...
            data.addColumn('number', 'Badges Count');
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <h1>Number of badges users have</h1>
